HELMET_GOGGLES(H_Simc_M1_erdl_ns,H_Simc_M1_erdl_swdg,G_SWDG);
HELMET_GOGGLES(H_Simc_M1_bitch_flip_ns,H_Simc_M1_bitch_flip_swdg,G_SWDG);
HELMET_GOGGLES(H_Simc_M1_bitch_ns,H_Simc_M1_bitch_swdg,G_SWDG);
...
HELMET_GOGGLES(H_Simc_M1C_bitch_ns,H_Simc_M1C_bitch_swdg,G_SWDG);
